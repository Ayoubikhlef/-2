...
export function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-br from-primary via-primary to-blue-900 dark:from-[#060d1f] dark:via-[#0a1733] dark:to-[#060d1f] text-white py-12 border-t border-white/5">
